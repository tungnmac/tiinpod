  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center p-8 md:p-16 select-none bg-gray-50/20">
      ...
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[40%] w-[55%] h-[65%] border-2 border-dashed border-indigo-400/20 rounded-lg overflow-visible pointer-events-none">
          <div 
